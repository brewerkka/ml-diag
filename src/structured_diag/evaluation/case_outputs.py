...
from structured_diag.labels import to_stage1
...
def _system_version() -> str:
    try:
        from structured_diag import __version__ as v
...
def write_case_outputs(
    ...
    *,
    ...
    from structured_diag.interpretation import render_markdown as render_interp_md
