...
if TYPE_CHECKING:
    from structured_diag.diagnosis.conformal_layer import ConformalCalibrator
    from structured_diag.diagnosis.stacking_resolver import StackingMetaModel
...
def cascade_marginal_proba(
    ...
    from structured_diag.models.inference import diagnose_batch
...
def resolve_llm_arbitrate(
    ...
    *,
    ...
    from structured_diag.diagnosis.arbitrator import (
        ArbitratorConfig,
        arbitrate_one,
    )

    arb_cfg = ArbitratorConfig(
        backend=str(config.arbitrator_backend),  # type: ignore[arg-type]
...
def build_stacking_diagnoses(
    *,
    ...
    from structured_diag.diagnosis.stacking_resolver import stacking_predict
...
def build_stacking_with_conformal_diagnoses(
    *,
    ...
    from structured_diag.diagnosis.conformal_layer import predict_with_conformal
    from structured_diag.diagnosis.stacking_resolver import stacking_predict
