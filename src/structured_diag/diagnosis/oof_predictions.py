...
if TYPE_CHECKING:
    from structured_diag.diagnosis.arbitrator import ArbitratorConfig
...
def _maybe_arbitrate_holdout(
    *,
    ...
    from structured_diag.diagnosis.arbitrator import arbitrate_one
    from structured_diag.evaluation.explanation import build_evidence
    from structured_diag.models.inference import diagnose_one
...
def generate_oof_predictions(
    *,
    ...
    from structured_diag.diagnosis.hybrid_resolver import flat_proba_aligned
    from structured_diag.models import stage1 as _stage1_mod
    from structured_diag.models import stage2 as _stage2_mod
    from structured_diag.models import stage3 as _stage3_mod
    from structured_diag.models.flat_baseline import (
        train_flat_baseline,
    )
    from structured_diag.models.inference import HierarchicalCascade
